        ...
        <div className="instruction">
            <div className="container centered w-600 py-20">
                ...
                <p>
                    ...
                    Если что-то непонятно или есть вопрос, можно задать его введя текстовое поле.<br/>
                ...
                <p>
                    Следующий урок откроется только после того, как будет проверно твоё домашнее задание.
